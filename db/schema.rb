...
ActiveRecord::Schema.define(version: 20140627150147) do
  ...
  add_index "votings", ["votable_type", "votable_id", "user_id"], name: "index_votings_on_votable_type_and_votable_id_and_user_id", unique: true, using: :btree
